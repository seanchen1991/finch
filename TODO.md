...
### Deployment
- [ ] **Bundling** - Bundle up `finch` as a downloadable tool for others to install
  - [ ] Figure out what needs to happen on first run when `finch` is installed onto a new machine
